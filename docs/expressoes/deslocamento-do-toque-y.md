---
title: "Deslocamento do toque Y"
description: "Diferença vertical entre o ponto atual e o início do toque."
---
...
<p class="node-purpose">Diferença vertical entre o ponto atual e o início do toque.</p>

## O que retorna

Diferença vertical entre o ponto atual e o início do toque.

## Como escrever

<div class="expression-token" style="--expression-color: #FB923C"><code>touch.delta_y</code></div>
...
<div class="expression-example-list" style="--expression-color: #FB923C">
  <section class="expression-example">
    ...
    <pre><code>touch.delta_y</code></pre>
    <p>Positivo indica baixo; negativo indica cima.</p>
  </section>
  <section class="expression-example">
    <strong>2. Distância sem sinal</strong>
    <pre><code>math.abs(touch.delta_y)</code></pre>
    <p>Mede apenas o deslocamento vertical.</p>
  </section>
  <section class="expression-example">
    <strong>3. Limitar a resposta</strong>
    <pre><code>math.clamp(touch.delta_y, -100, 100)</code></pre>
    <p>Limita um controle vertical entre -100 e 100.</p>
  </section>
</div>
