...
Use quando o jogo precisa manter sempre a mesma área horizontal.

::: warning Área visível
Como outras telas podem mostrar uma área maior da cena, evite deixar partes indesejadas muito próximas das bordas da câmera base.
:::

## Próximo passo

Depois de criar o projeto, entre nele e crie a primeira cena. Em seguida, adicione objetos e coloque suas instâncias no editor.
