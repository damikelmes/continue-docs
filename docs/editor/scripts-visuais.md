...
| Se você precisa… | Coloque primeiro |
| --- | --- |
| Mover o jogador e depois centralizar a câmera | O movimento do jogador |
| Alterar uma variável e depois compará-la | A ação que altera a variável |
