...
- Nome do executável.
- Resolução base.
- Modo de ajuste em outras telas.
...
- O executável com o nome e o ícone do jogo.
- O arquivo `game.continue` com as cenas, objetos, scripts e imagens necessárias.
...
Abra o ZIP em um computador, extraia todos os arquivos e execute o jogo para conferir controles, câmera, iluminação e desempenho.
:::
