...
description: "Dispara uma vez quando o objeto deixa de se mover."
---
...
<p class="node-purpose">Dispara uma vez quando o objeto deixa de se mover.</p>

## Para que serve

Dispara uma vez quando o objeto deixa de se mover.
...
<div class="node-example" style="--node-page-color: #FB7185">
  <ol>
    ...
    <li>Conecte a animação Parado.</li>
  </ol>
  <p class="node-result"><strong>Resultado:</strong> A ação dispara quando a instância deixa de se mover.</p>
</div>
